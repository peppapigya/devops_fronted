      ...
      <div   style="display: flex;flex-direction: column;height: 100%">
        ...
        <el-card style="height: calc(100% - 235px)" body-style="padding:0px;height:100%" >
          <el-scrollbar height="100%" style="padding:15px;" ref="scrollbarRef"  always @scroll="scroll">
            <div ref="items">
              <div  :class="{msg:true,'msg-self':m.fromId == 'me' }"   v-for="(m,index) in msgList" :key="index">
                <div class="msg-img" v-if="m.fromId!='me'">
                  <el-avatar :src="'https://img1.baidu.com/it/u=199283956,1140565848&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=500'" alt="" shape="square"/>
                </div>
                <div class="msg-text">
        ...
        <el-card style="height: 170px;margin-top: 5px;">
          <el-input type="textarea" :rows="4" resize="none" v-model="msg.message" @keyup.enter="sendMsg"/>
